...
function randomColor() {
    ...
    let randomedcolor = `rgb(${red}, ${green}, ${blue})`
    document.body.style.backgroundColor = randomedcolor
}
function randomQuote() {
    let randomNumber = Math.floor(Math.random() * quotes.length)
    let currentQuote = quotes[randomNumber].quote
    let currentQuoteSource = quotes[randomNumber].source
    document.querySelector('.quotesDisplay').innerText = currentQuote
    document.querySelector('.source').innerText = currentQuoteSource
    randomColor()
}
